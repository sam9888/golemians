...
// Ladder: step 0 = nothing banked. Climbing to step 1/2 requires
// surviving that step's roll. Step 2 (FCFS) is the top - reaching it
// is automatic, no further pushing possible. GTD is closed and has
// been removed from the game entirely - it's no longer a reachable
// outcome, only Public and FCFS are.
//
// Per-step survival probabilities: for a player who always pushes as
// far as possible, this works out to roughly FCFS 10%, Public 15%,
// nothing 75%.
